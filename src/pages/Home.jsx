...
// ✅ Skeleton Component (ডাটা লোড হওয়ার আগে এটি দেখাবে)
const HabitSkeleton = () => (
...
const Home = () => {
  ...
  return (
    <div className="bg-base-200 min-h-screen font-sans transition-colors duration-300">
     ...
     {/* 4. Featured Habits (Redesigned & Modern) */}
<section className="max-w-7xl mx-auto px-6 mb-24">
    ...
    <div className="text-center mt-16">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-20 text-center">
          <h2 className="text-3xl font-bold mb-10 text-base-content">Meet The Team</h2>
          <div className="flex justify-center gap-8 flex-wrap">
             <div className="flex flex-col items-center">
                 <div className="avatar mb-3"><div className="w-24 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2"><img src="https://i.pravatar.cc/150?img=60" alt="team" /></div></div>
                 <h4 className="font-bold">Alex Doe</h4><p className="text-xs opacity-70">CEO</p>
             </div>
             <div className="flex flex-col items-center">
                 <div className="avatar mb-3"><div className="w-24 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2"><img src="https://i.pravatar.cc/150?img=52" alt="team" /></div></div>
                 <h4 className="font-bold">John Smith</h4><p className="text-xs opacity-70">CTO</p>
             </div>
          </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 mb-20">
         <h2 className="text-3xl font-bold text-center text-base-content mb-8">FAQ</h2>
         <div className="join join-vertical w-full">
            <div className="collapse collapse-arrow join-item border border-base-300 bg-base-100">
                <input type="radio" name="my-accordion-4" defaultChecked /> 
                <div className="collapse-title text-xl font-medium">Is it free?</div>
                <div className="collapse-content"><p>Yes, basic version is free forever.</p></div>
            </div>
            <div className="collapse collapse-arrow join-item border border-base-300 bg-base-100">
                <input type="radio" name="my-accordion-4" /> 
                <div className="collapse-title text-xl font-medium">Can I use Dark Mode?</div>
                <div className="collapse-content"><p>Yes! We support light and dark themes.</p></div>
            </div>
         </div>
      </section>
